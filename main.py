...
if uploaded_file is not None:
    ...
    if time_variable and options and value:
        ...
        for key, df in data.set_index(time_variable).groupby(options)[value]:
            ...
            # generate index for selected interval
            ...
            df = pd.DataFrame({value: new.tolist()}, index=full_index)
        ...
        # plot a sample of final dataset
        with st.expander("Plot generated data"):
            i = 0
